...
func TestErrors(t *testing.T) {
	...
	ServiceUnavailable(r, "Test message.", errors.New("HTTP Service unavailable"))
	...
	// Test 2
	r = httptest.NewRecorder()
	InternalServer(r, "Test message.", errors.New("HTTP Internal Server"))
	...
	// Test 3
	r = httptest.NewRecorder()
	NotFound(r, "Test message.", errors.New("HTTP Not found"))
	...
	// Test 4
	r = httptest.NewRecorder()
	BadRequest(r, "Test message.", errors.New("HTTP Bad Request"))
